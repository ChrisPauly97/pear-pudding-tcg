...
public class Ghoul extends Card {
    public Ghoul(float x, float y, float width, float height, Color color, Player player, Slot s) {
        super(x, y, width, height, color, 3, 4, 3, MINION, ETHEREAL, StatusEffects.effects.get("Consume"), player, s);
